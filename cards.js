//Places where code is probably needed for adding a new type of deck is marked with ##ADD
var cards = (function () {
	//The global options
	var opt = {
		cardSize: {
			//Padding controls the width of the card spacing in hands
	...
	function init(options) {
		...
		switch (opt.type) {
			...
			case TAROT_MA:
				...
				opt.cardsUrl = 'img/tma_cards.png';
				opt.standardDeck = false;
				break;
			//##ADD 
		}
	...
	Card.prototype = {
		...
		showCard: function () {
			var offsets = {
				...
				"bj": 3,
				"tma": 0
				//##ADD if you need custom offsets for displaying cards
			};
